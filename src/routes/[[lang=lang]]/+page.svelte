<script>
	...
	import {
		SECTION_IMAGE_MEDIA_DATA,
		SLIDER_IMAGE_MEDIA_DATA,
	} from "$lib/js/client/constants.media.data.client";
	import { L } from "$lib/js/client/localization/localization.translations.data.client";
	import {
		getFullLocalizedURL,
		getLocalizedLink,
	} from "$lib/js/client/localization/localization.util.client";
	import {
		getStore,
...
<svelte:head>
	...
	<link
		rel="alternate"
		hreflang="x-default"
		href={getFullLocalizedURL("", "", PUBLIC_DEFAULT_LANGUAGE)}
	/>
	...
	{#each SLIDER_IMAGE_MEDIA_DATA as media}
		<link
			...
			href={getLinkForResponsiveImage(
				"premium-mermer-slider-marble-one",
				media,
				undefined,
				false,
			)}
...
<section
	id="homepage"
	class="flex f-column page-g w-100 max-w"
...
>
	<div class="full-width">
		<Slider absoluteIndicators>
			<article
				id="slider-homepage"
				class="slider-content flex w-100 b-r-d o-hidden"
			>
				<article class="b-box slider-item p-h-d">
					...
					>
						...
						<article
							class="slider-text-wrapper p-a grid g-1dot25 p-d"
						>
							<h2 class="slider-text-title f-w-600">
								{L("slider-item-title-one", $lang)}
							</h2>
				...
				<article class="b-box slider-item p-h-d">
					...
					>
						...
						>
							<h2 class="slider-text-title f-w-600">
								{L("slider-item-title-three", $lang)}
							</h2>
							<p class="slider-text-content article-text">
	...
	>
		<div class="flex f-column a-i-c g-1 t-a-c">
			...
			<div class="texts-after-icons grid g-dot5">
				<p class="title-of-icon section-text f-w-500">
					{L("text-with-icon-title-one", $lang)}
				</p>
		...
		<div class="flex f-column a-i-c g-1 t-a-c">
			...
			<div class="texts-after-icons grid g-dot5">
				<p class="title-of-icon section-text f-w-500">
					{L("text-with-icon-title-two", $lang)}
				</p>
				<p class="text-of-icon article-text">
		...
		<div class="flex f-column a-i-c g-1 t-a-c">
			...
			<div class="texts-after-icons grid g-dot5">
				<p class="title-of-icon section-text f-w-500">
					{L("text-with-icon-title-three", $lang)}
				</p>
				<p class="text-of-icon article-text">
		...
		>
			<div class="section-texts g-v-d flex f-column small-screen-t-a-c">
				<h2 class="section-title">
					{L("homepage-section-title-one", $lang)}
				</h2>
				...
				<a
					href={getLocalizedLink("products", $lang)}
			...
			<div
				class="section-img-wrapper img-wrapper hoverable-image-wrapper w-100 o-hidden b-r-d"
			>
				<LazyImage
					mode={MODE_LAZY_IMAGE_WHEN_VISIBLE}
					classes="hoverable-image w-h-100 m-h-auto b-r-d"
	...
	>
		...
		<div class="section-texts g-v-d flex f-column small-screen-t-a-c">
			<h2 class="section-title">
				{L("homepage-section-title-two", $lang)}
			</h2>
			<p class="section-text">
			...
			<a
				href={getLocalizedLink("about-us", $lang)}
				class="button small-button small-screen-m-h-auto"
	...
	<div class="full-width page-p-v-d p-h-d secondary-background-color">
		...
		>
			<div class="section-texts g-v-d flex f-column small-screen-t-a-c">
				<h2 class="section-title">
					{L("homepage-section-title-three", $lang)}
				</h2>
				<p class="section-text">
	...
	>
		...
		<div class="section-texts g-v-d flex f-column small-screen-t-a-c">
			<h2 class="section-title">
				{L("homepage-section-title-four", $lang)}
			</h2>
			<p class="section-text">
			...
			<a
				href={getLocalizedLink("contact", $lang)}
				class="button small-button small-screen-m-h-auto"
